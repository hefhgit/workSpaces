...
//		style.setFillForegroundColor(IndexedColors.BLUE.getIndex());
       ...
       Sheet sheet2 = workbook.createSheet("终止登记1");
       Sheet sheet3 = workbook.createSheet("终止登记2");
       ...
       sheet.setColumnWidth(1, 22000);
        ...
        //输出到磁盘中
        FileOutputStream fos = new FileOutputStream(new File("E:\\111.xlsm"));
        workbook.write(fos);
